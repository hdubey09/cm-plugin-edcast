...
"""
cm_plugin documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'cm_plugin',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edcast/cm_plugin",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Extra plugin introduce to connect the openedx with savannah',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'cm_plugin'),
                os.path.join(root_path, 'cm_plugin/migrations')])
