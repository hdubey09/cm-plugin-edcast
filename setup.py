#!/usr/bin/env python
"""
Package metadata for cm_plugin.
"""
import os
import re
import sys
...
VERSION = get_version('cm_plugin', '__init__.py')
...
setup(
    name='cm_plugin',
    version=VERSION,
    description="""Extra plugin introduce to connect the openedx with savannah""",
    long_description=README + '\n\n' + CHANGELOG,
    author='EdCast',
    author_email='hdubey@csod.com',
    url='https://github.com/edcast/cm_plugin',
    packages=find_packages(
        include=['cm_plugin', 'cm_plugin.*'],
        exclude=["*tests"],
    ),
