...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd cm_plugin && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd cm_plugin && i18n_tool generate

detect_changed_source_translations:
	cd cm_plugin && i18n_tool changed
...
pull_translations:
	find cm_plugin/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/cm_plugin/cm_plugin/conf/locale:cm_plugin/conf/locale
